...
public class FitingDetailDto {
    ...
    @JsonProperty("nmFiting")
    private String nmFiting;
    ...
    public String getNmFiting() {
        return nmFiting;
    }

    public void setNmFiting(String nmFiting) {
        this.nmFiting = nmFiting;
    }
